...
$admin_email = 'adilsoomro.s@gmail.com'; // Your Email
...
class Contact_Form{
	function __construct($details, $email_admin, $message_min_length){
		...
		$this->subject = 'New message from website!'; // Subject 
	...
	private function sendEmail(){
		...
		{
			$this->response_status = 1;
			$this->response_html = '<p>Than you for your message. We will contact you soon.</p>';
		}
	}
